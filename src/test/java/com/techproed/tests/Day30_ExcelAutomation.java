...
import com.techproed.pages.Day30_DataTablesExcel;
...
public class Day30_ExcelAutomation {
    Day30_DataTablesExcel dataTablesExcel = new Day30_DataTablesExcel();
    ExcelUtil excelUtil;
    List<Map<String,String >> testData;

    @BeforeMethod
    public void getTestData(){
        //ExcelUtil class'ini kullanarak file ve sheet'in path'ini veriyoruz.
       excelUtil= new ExcelUtil("src/test/resources/exceldata.xlsx","Sheet1");
       //ExcelUtil class'indan getdataList() methodunu excelden data alabilmek icin cagiralim.
